...
if __name__ == '__main__':
    ...
    if options.runTest != None:
        grades = runTest(options.runTest, moduleDict, printTestCase=options.printTestCase, display=getDisplay(True, options))
        print(grades.points.totalCount())
        print(grades.exit_code)
    else:
        ...
        print(grades.points.totalCount())
        print("Exit code:{}".format(grades.exit_code))
        
        sys.exit(grades.exit_code)        
